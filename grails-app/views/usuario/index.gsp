...
<body>
	<a href="#list-usuario" class="skip" tabindex="-1"><g:message
			...
			<thead>
				<tr>
					<g:sortableColumn property="login"
						title="${message(code: 'usuario.login.label', default: 'Login')}" />

					<g:sortableColumn property="senha"
						title="${message(code: 'usuario.senha.label', default: 'Senha')}" />

					<g:sortableColumn property="permissao"
						title="${message(code: 'usuario.permissao.label', default: 'Permissao')}" />
				</tr>
			</thead>
			<tbody>
